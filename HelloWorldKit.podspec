#
#  Be sure to run `pod spec lint HelloWorldKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version      = "0.0.1"
  s.summary      = "Creates a new modal view controller that says Hello World"
  ...
  s.author             = { "Bryan Yeung" => "bryanyng@gmail.com" }
  # Or just: s.author    = ""
  # s.authors            = { "" => "" }
  ...
  s.source_files  = "HelloWorldKit", "HelloWorldKit/**/*.{h,m}"
